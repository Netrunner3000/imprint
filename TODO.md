...
paid workflow outside it (tracked in agents/course/TODO.md). 709 tests pass in
...
Music, Site Builder, Audiobook and Client Gigs now own their workspace layouts
and request/result lifecycles in their own packages. Temporary control aliases
