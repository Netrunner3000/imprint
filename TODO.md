...
All ten workspaces own their layouts and request/result lifecycles in their
own packages. The temporary host-control aliases are retired as of 2026-09-21:
shared integrations resolve panel controls through `GodAI._find_control()`.
