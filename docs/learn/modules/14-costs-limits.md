...
- You know the current session and daily caps.
...
| Session / daily | Recorded usage against guardrails | Stop or reduce scope before another request |
| Unpriced / unknown | No trustworthy local rate for this action | Investigate externally; never interpret as zero |

## Walkthrough

1. Set both session and daily caps before starting a long or batched job.
