...
- [ ] `P1` Bind drafts, profiles and exports to the shared Project record. First slice done 2026-09-22: named projects now isolate and restore Book Profile plus all four manuscript editors, autosave and flush on close, and share title/byline with the Project record. Export files still need project artifact links, and Publishing Manager still needs to read the approved manuscript.
